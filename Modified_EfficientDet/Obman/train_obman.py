...
def main():
    ...
    traingen = dataGenerator_obman(dir_path, batch_size = 8, data_set = 'train')
    validgen = dataGenerator_obman(dir_path, batch_size= 8, data_set = 'val')
    ...
    validgen2 = dataGenerator_obman(dir_path, batch_size= 10, data_set = 'val')
...
if __name__ == '__main__':
    ...
    print("THIS IS USED FOR OBMAN, MAKE SURE INPUT SIZE IN NETWORK IS CORRECT, 256x256")
    main()
