...
def main():
    ...
    validgen2 = dataGenerator_RHD(dir_path, batch_size= 10, data_set = 'validation')
...
if __name__ == '__main__':
    ...
    print("THIS IS USED FOR RHD, MAKE SURE INPUT SIZE IN NETWORK IS CORRECT, 320x320")
    main()
