...
def evaluate_result(output_dir, save_path, xyz_pred, xyz_target, xy_pred, xy_target, got_3d=True):
    ...
    xy_mean2d, _, xy_auc2d, pck_xy, thresh_xy = eval_xy.get_measures(0.0, 30, 100)
    ...
    xy_mean2d_al, _, xy_auc2d_al, pck_xy_al, thresh_xy_al = eval_xy_aligned.get_measures(0.0, 30, 100)
